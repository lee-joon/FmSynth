...
#ifndef FM_synthesisSource_H
#define FM_synthesisSource_H

#include "FM_synthesisSourceParams.h"
#include "LookUpTable_Util.h"
...
private:
    FM_synthesisSourceParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkSourcePluginContext* m_pContext;
    AkFXDurationHandler m_durationHandler;

    UtilLookupTable Util;
    AkUInt32 m_SampleRate;
    AkUInt32 m_Timer;

    NoiseGenerator RandomValue;

    AkReal32 m_R_fOsc_Frequence;
    AkReal32 m_R_fOsc_1st_Amp;
    AkReal32 m_R_fOsc_2nd_Amp;
    AkReal32 m_R_fOsc_1st_FRQ;
    AkReal32 m_R_fOsc_2_Frequence;
};

#endif // FM_synthesisSource_H
