...
#include "FM_synthesisPluginGUI.h"

FM_synthesisPluginGUI::FM_synthesisPluginGUI()
{
}

ADD_AUDIOPLUGIN_CLASS_TO_CONTAINER(
    FM_synthesis,            // Name of the plug-in container for this shared library
    FM_synthesisPluginGUI,   // Authoring plug-in class to add to the plug-in container
